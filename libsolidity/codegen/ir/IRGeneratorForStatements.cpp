...
void IRGeneratorForStatements::endVisit(FunctionCall const& _functionCall)
{
	...
	case FunctionType::Kind::ABIEncodeWithSignature:
	{
		...
		if (functionType->kind() == FunctionType::Kind::ABIEncodeWithSignature)
		{
			...
			else
			{
				...
				// This is an abuse of the `allocateUnbounded` function.
				...
				m_code << m_utils.allocateUnboundedFunction() << "(" << freeMemoryPre << ", 0)\n";
			}
		}
		...
		templ("finalize", m_utils.finalizeAllocationFunction());
	...
	case FunctionType::Kind::Creation:
	{
		...
		t("releaseMemory", m_utils.releaseMemoryFunction());
	...
	case FunctionType::Kind::SHA256:
	{
		...
		templ("allocateUnbounded", m_utils.allocateUnboundedFunction());
		templ("releaseMemory", m_utils.releaseMemoryFunction());
		templ("pos", m_context.newYulVariable());
		templ("end", m_context.newYulVariable());
